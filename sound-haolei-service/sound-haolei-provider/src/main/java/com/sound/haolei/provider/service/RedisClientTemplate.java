...
public class RedisClientTemplate {
    ...
    public void setList(String key ,List<Map<String,Object>> list){  
        try {  
            set(key,JSONObject.toJSONString(list));  
        } catch (Exception e) {  
    ...
    public List<Map<String,Object>> getList(String key){  
        ...
        List<Map<String,Object>> list =  (List<Map<String,Object>>)JSONObject.parse(in);    
        return list;  
    }  
    ...
    public void setMap(String key ,Map<String,Object> map){  
        try {  
            set(key, JSONObject.toJSONString(map));
        } catch (Exception e) {  
            log.error("Set key error : "+e);  
        }  
    }  
    ...
    public Map<String,Object> getMap(String key){  
        ...
        Map<String,Object> map =  (Map<String,Object>)JSONObject.parseObject(in, Map.class);   
        return map;  
    }  
}
